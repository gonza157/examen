...
void harcodeoOrquesta(eOrquesta* client,int len)
{
    ...
    strcpy(client[0].lugar,"lospa");
    client[0].isEmpty=0;

    client[1].idorquesta=2;
    strcpy(client[1].nombre,"matias");
    client[1].tipo.idtipo=2;
    strcpy(client[1].lugar,"palmu");
    client[1].isEmpty=0;

    client[2].idorquesta=3;
    strcpy(client[2].nombre,"alejandria");
    client[2].tipo.idtipo=3;
    strcpy(client[2].lugar,"laborde");
    client[2].isEmpty=0;

    client[3].idorquesta=4;
    strcpy(client[3].nombre,"optimo");
    client[3].tipo.idtipo=1;
    strcpy(client[3].lugar,"gran rex");
    client[3].isEmpty=0;
